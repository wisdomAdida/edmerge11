        ...
        <div className="md:col-span-1">
          ...
          <div className="hidden md:block">
            <Card className="bg-primary/5 mb-6">
              ...
              <CardContent>
                <CardDescription>
                  As a tutor, you can communicate with students, other tutors, and administrators. 
                  All messages are end-to-end encrypted for security and privacy.
                </CardDescription>
              </CardContent>
            </Card>
          ...
          {currentChatRoomId && currentRecipientId ? (
            ...
            <div className="flex flex-col items-center justify-center h-[600px] bg-muted/30 rounded-lg border p-8 text-center">
              ...
              <p className="text-muted-foreground max-w-md">
                ...
                or continue an existing one. As a tutor, you can reach out to students
                for course-related discussions or collaborate with other tutors.
              </p>
            </div>
          )}
        </div>
